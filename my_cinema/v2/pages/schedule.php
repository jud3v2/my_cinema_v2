...
<head>
    ...
    <title>My Cinema Programmer votre séance</title>
</head>
<body>
...
<main class="mx-3">
    <div>
        <h1 class="text-bold py-3 text-4xl  font-black">Rechercher les séances programé !</h1>
    </div>
    ...
    <div>
        <h3 class="text-bold py-3  text-xl font-black">Rechercher un film programmer</h3>
    </div>
    <div class="py-5 mb-5">
        <form>
            ...
            <div class="relative">
                ...
                <input type="search" id="default-search" class="block w-full p-4 ps-10 text-sm text-gray-900 border border-gray-300 rounded-lg bg-gray-50 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Rechercher un film." required>
                <button id="submit-schedule-button" type="submit" class="text-white absolute end-2.5 bottom-2.5 bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-4 py-2 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Rechercher</button>
            </div>
        </form>
    </div>
    <div>
...
<script src="http://localhost:8000/script/schedule.js"></script>
</html>
