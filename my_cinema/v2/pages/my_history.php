...
<head>
    ...
    <title>My Cinema Mon historique</title>
</head>
<body>
...
<main class="mx-3">
    <div>
        <h1 class="text-bold py-3 text-4xl  font-black">Historique des films visionné !</h1>
    </div>
    ...
    <div>
        <h3 class="text-bold py-3  text-xl font-black">Rechercher l'historique d'un client</h3>
    </div>
    <div class="py-5 mb-5">
        <form>
